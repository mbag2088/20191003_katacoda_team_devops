...
docker run -dt --name managed_node1  --network mynetwork  22072017/ubuntu:ansible-cible.16.04.1 /bin/bash;
docker run -dt --name managed_node2  --network mynetwork  22072017/ubuntu:ansible-cible.16.04.1 /bin/bash;
